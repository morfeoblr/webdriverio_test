...
exports.config = {
  ...
  cucumberOpts: {
    ...
    tags: ['~@Pending'], // <string[]> (expression) only execute the features or scenarios with tags matching the expression
